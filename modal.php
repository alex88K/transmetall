<div id="modal-callback" class="modal fade" tab-index="-1" role="dialog" aria-labelledby="modal-callback">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-callback-wrap">
            ...
            <div class="form-group submit-wrap"><input type="submit" name="submit" class="btn btn-g btn-submit" value="Отправить"></div>
         </form>
		</div>
      ...
      <div class="modal-content">
         <div class="modal-body">
            <div class="mess-body">
         	...
         	<button type="button" class="btn btn-g btn-red" data-dismiss="modal" aria-label="Close">Вернуться на сайт</button>
         </div>
      </div>
   </div>
</div>
